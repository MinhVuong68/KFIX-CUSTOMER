...
const Register = () => {
  const { error, isRegister, isVerify, loading } = useSelector(
    (state) => state.auth
  );
  ...
  const [confirmPassword, setconfirmPassword] = useState("03862006961");
  ...
  console.log(error, isRegister, isVerify, loading);
